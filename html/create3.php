<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        header('Location: create4.php'); // Redirect to the next page
        exit();
    }
?>
<!DOCTYPE html>
    ...
    <section class="create-container" >
        ...
        <div class="main-content3">
            <form action="" id="formArea" method="post">
                ...
                <textarea id="myTextarea" form="formArea" rows="4" cols="50" placeholder="Type here..." name="project-overview"></textarea>
                ...
                <div class="editor">
                    ...
                    <!-- The editable area -->
                    <textarea id="editor" form="formArea" name="project-story" contenteditable="true" style="padding: 10px; min-height: 200px;"></textarea>
