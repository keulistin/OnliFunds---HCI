...
<section class="hero">
    <div class="hero-text"> 
        ...
        <div class="hero-buttons">
            <button class="learn-more"><a href="about.html" style="text-decoration:none;">Learn More</a></button>
            <button class="donate"><a href="projects.html" style="text-decoration:none;">Donate</a></button>
        </div>
    </div>
...
<section class="statistics">
    <div class="stat-item">
        <h2 class="stat-value" style="color:white;">20</h2>
    ...
    <div class="stat-item">
        <h2 class="stat-value"style="color:white;">4</h2>
